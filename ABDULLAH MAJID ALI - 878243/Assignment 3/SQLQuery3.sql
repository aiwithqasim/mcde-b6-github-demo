...
-- Task 17: Show all stores and the products they have in stock, including product name and
...
-- Task 19: List ALL customers and their orders (if any). Customers who never ordered should
-- still appear with NULL order data.
SELECT
    c.first_name + ' ' + c.last_name AS customer_full_name,
    o.order_id,
    o.order_date
