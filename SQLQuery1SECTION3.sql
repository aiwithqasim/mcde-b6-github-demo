...
--TASK 15 .-- list all staf name along with their store name
SELECT 
    s.first_name + ' ' + s.last_name AS staff_name,
        ...
        --TASK 16 : list all staf members full name along with their store name
SELECT 
...
-- Task 16:  List staff members along with their manager's ull name.
SELECT 
    s.first_name + ' ' + s.last_name AS staff_name,
