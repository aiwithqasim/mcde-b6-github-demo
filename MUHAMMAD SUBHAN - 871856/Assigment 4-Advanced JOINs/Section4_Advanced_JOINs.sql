...
-- Self Join | Cross Join | Right Join | Left Anti Join
...
-- ============================================================
-- Task 41: List each staff member alongside their manager's 
--          full name. If a staff member has no manager 
...
INNER JOIN production.products AS p2
    ...
    AND p1.product_id < p2.product_id          -- avoid duplicates & self-matches
...
-- Hint: Useful to find which brand-category combos have no products.
-- ============================================================
SELECT 
    b.brand_name,
    c.category_name
...
--          categories, find brand-category combinations that 
--          have NO products 
--          (LEFT JOIN the cross join result against products 
...
INNER JOIN sales.orders AS o
    ON c.customer_id = o.customer_id                -- customers who placed at least one order
LEFT JOIN (
    -- customers who ordered at least one Trek product
...
WHERE trek_customers.customer_id IS NULL;           -- exclude those who ordered Trek
