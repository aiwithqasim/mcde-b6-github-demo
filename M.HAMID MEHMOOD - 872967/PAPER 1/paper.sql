...
-- 4. (Easy) Calculate total revenue per store sorted highest to lowest
SELECT 
    s.store_name,
...
-- 5. (Medium) Brand stats with more than 5 products
SELECT 
    b.brand_name,
...
-- 6. (Medium) Number of orders and total revenue per month for year 2017
SELECT 
